...
import {
  ...
  Flame, DollarSign, Handshake, ChevronRight, Sparkles, ExternalLink
} from "lucide-react";
              ...
              <tbody>
                {fundingEvents.map((ev, i) => (
                  <tr key={i} className="border-t border-white/10 hover:bg-white/[0.02] transition-colors">
                    ...
                    <td className="p-3">
                      {ev.source_url ? (
                        <a href={ev.source_url} target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:text-indigo-300 hover:underline flex items-center gap-1 text-xs">

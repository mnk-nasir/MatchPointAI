...
import { LayoutDashboard, Briefcase, Star, Calendar, MessageSquare } from "lucide-react";
...
export default function Sidebar() {
  return (
    <aside className="w-64 flex-shrink-0 border-r border-white/10 bg-white/[0.03] hidden md:block">
